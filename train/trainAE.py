...
def trainAE(trainLoader: DataLoader, valLoader: DataLoader, testLoader: DataLoader, dataset: dict, modelConfigs: dict):
    model = Autoencoder()
    ...
    # Evaluation for validation data with normal class
    model.eval()
    idx = 0
    reconErrorVal = []
